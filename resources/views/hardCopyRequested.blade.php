...
<div id="wrapper" class="toggled"> 
  ...
  <div id="page-content-wrapper">
    <div class="ofs_dashboard managePage manageCPage">
      ...
      <!-- TopBar-->
      <div class="pageTitle">
        <h1 class="title title_icon_manageC">MANAGE HARD COPY REQUESTS</h1>
      </div>
      <!-- page title-->
      ...
      <div class="table-responsive">
        <table class="table customSelect">
          <thead>
            <tr>
              <th style="width:35%;">DC Number</th>
        ...
        <option selected> Document Type </option>
              ...
              <img src="images/ic-upload.png" alt="Upload document">PROVIDED</a>
